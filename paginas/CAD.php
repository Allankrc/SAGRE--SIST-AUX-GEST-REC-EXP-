...
<p  style="text-align: left; color:blue" >Início - Cadastro</p>
<H1 style="text-align: left;"> CADASTRO DE USUÁRIO </H1>

<H2 style="text-align: left;"> Informações Básicas </h2>
<form style="text-align: left;"     action="recebe.php" >
...
<form style="text-align: left;" action="recebe.php" method="post">
...
<button type="reset" class="btn btn-light btn-lg" name="clean"> Limpar </button>
